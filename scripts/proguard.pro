...
-libraryjars 'tempLibraries/authlib-1.5.21.jar'
-libraryjars 'tempLibraries/codecjorbis-20101023.jar'
-libraryjars 'tempLibraries/codecwav-20101023.jar'
-libraryjars 'tempLibraries/commons-codec-1.9.jar'
-libraryjars 'tempLibraries/commons-compress-1.8.1.jar'
-libraryjars 'tempLibraries/commons-io-2.4.jar'
-libraryjars 'tempLibraries/commons-lang3-3.3.2.jar'
-libraryjars 'tempLibraries/commons-logging-1.1.3.jar'
-libraryjars 'tempLibraries/fastutil-7.1.0.jar'
-libraryjars 'tempLibraries/gson-2.2.4.jar'
-libraryjars 'tempLibraries/guava-17.0.jar'
...
-libraryjars 'tempLibraries/jna-3.4.0.jar'
...
-libraryjars 'tempLibraries/log4j-core-2.0-beta9.jar'
...
-libraryjars 'tempLibraries/netty-all-4.0.23.Final.jar'
...
-libraryjars 'tempLibraries/realms-1.7.59.jar'
