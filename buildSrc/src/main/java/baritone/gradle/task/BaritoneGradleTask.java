...
class BaritoneGradleTask extends DefaultTask {
    ...
    protected Path artifactPath, artifactUnoptimizedPath, artifactApiPath, artifactStandalonePath, artifactForgeApiPath, artifactDeobfPath, artifactForgeStandalonePath, proguardOut;
